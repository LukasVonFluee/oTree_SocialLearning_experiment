...
load('df_soc_learn_4round_busara.RData')
...
df_soc_learn_4round_busara$numIndLeftGreaterHalf <- rep(0,nrow(df_soc_learn_4round_busara))
df_soc_learn_4round_busara$numIndLeftGreaterHalf[df_soc_learn_4round_busara$number_observed_IL_right_urn > 5/2] <- 1

# Charles created a normalized independent variable. I already did that in the
# data_analysis_busara.R script, and the variable is called "propIndRightCentered"

# Charles creates here dummies for the tmt combinations. I already did that in 
# the data_analysis_busara.R script. In my case, the columns in 
# df_soc_learn_4round_busara.RData representing the treatments are called:
...
# I already created such a variable in data_analysis_busara.R, and the variable is called "blockID"
...
# data in data_analysis_busara.R. It is the data frame df_soc_learn_4round_busara.RData
...
temp <- df_soc_learn_4round_busara[(df_soc_learn_4round_busara$similar_ingroup_ncl_dummy == 1), ]
...
temp <- df_soc_learn_4round_busara[(df_soc_learn_4round_busara$dissimilar_ingroup_ncl_dummy == 1), ]
socLearnersPresent <- as.numeric(levels(as.factor(temp$uniqueSubjectNum)))
...
temp <- df_soc_learn_4round_busara[(df_soc_learn_4round_busara$similar_outgroup_ncl_dummy == 1), ]
socLearnersPresent <- as.numeric(levels(as.factor(temp$uniqueSubjectNum)))
...
temp <- df_soc_learn_4round_busara[(df_soc_learn_4round_busara$dissimilar_outgroup_ncl_dummy == 1), ]
socLearnersPresent <- as.numeric(levels(as.factor(temp$uniqueSubjectNum)))
...
temp <- df_soc_learn_4round_busara[(df_soc_learn_4round_busara$similar_ingroup_cl_dummy == 1), ]
socLearnersPresent <- as.numeric(levels(as.factor(temp$uniqueSubjectNum)))
...
temp <- df_soc_learn_4round_busara[(df_soc_learn_4round_busara$dissimilar_ingroup_cl_dummy == 1), ]
socLearnersPresent <- as.numeric(levels(as.factor(temp$uniqueSubjectNum)))
...
temp <- df_soc_learn_4round_busara[(df_soc_learn_4round_busara$similar_outgroup_cl_dummy == 1), ]
socLearnersPresent <- as.numeric(levels(as.factor(temp$uniqueSubjectNum)))
...
temp <- df_soc_learn_4round_busara[(df_soc_learn_4round_busara$dissimilar_outgroup_cl_dummy == 1), ]
socLearnersPresent <- as.numeric(levels(as.factor(temp$uniqueSubjectNum)))
...
quartz(width = widthWindow, height = heightWindow, type='pdf', file='plotNCLSimDisIngroupBySocialLearner_busara.pdf')
...
quartz(width = widthWindow, height = heightWindow, type='pdf', file='plotNCLSimDisOutgroupBySocialLearner_busara.pdf')
par(mar=c(5.5,5.5,4,3),mgp=c(3.5,1,0),cex.lab=cexNum,cex.axis=1.2*cexNum,fig=c(0,1,0.5,1))
plot(c(ambMinBeta,ambMaxBeta),c(0,0),xlim=c(ambMinBeta-4,ambMaxBeta+8),ylim=c(0,yMax),type='l',lty='solid',lwd=2,xlab='',ylab='Count',axes=F,cex.lab=1.75*cexNum)
axis(1,c(ambMinBeta-3,seq(from=ambMinBeta,to=ambMaxBeta,by=5),ambMaxBeta+3,ambMaxBeta+7),c('Min',seq(from=ambMinBeta,to=ambMaxBeta,by=5),'Maj','U'),cex.axis=1.75*cexNum)
axis(2,seq(from=0,to=yMax+1,by=2),seq(from=0,to=yMax+1,by=2),cex.axis=1.75*cexNum)
...
quartz(width = widthWindow, height = heightWindow, type='pdf', file='plotCLSimDisIngroupBySocialLearner_busara.pdf')
par(mar=c(5.5,5.5,4,3),mgp=c(3.5,1,0),cex.lab=cexNum,cex.axis=1.2*cexNum,fig=c(0,1,0.5,1))
plot(c(ambMinBeta,ambMaxBeta),c(0,0),xlim=c(ambMinBeta-4,ambMaxBeta+8),ylim=c(0,yMax),type='l',lty='solid',lwd=2,xlab='',ylab='Count',axes=F,cex.lab=1.75*cexNum)
axis(1,c(ambMinBeta-3,seq(from=ambMinBeta,to=ambMaxBeta,by=5),ambMaxBeta+3,ambMaxBeta+7),c('Min',seq(from=ambMinBeta,to=ambMaxBeta,by=5),'Maj','U'),cex.axis=1.75*cexNum)
axis(2,seq(from=0,to=yMax+1,by=2),seq(from=0,to=yMax+1,by=2),cex.axis=1.75*cexNum)
...
quartz(width = widthWindow, height = heightWindow, type='pdf', file='plotCLSimDisOutgroupBySocialLearner_busara.pdf')
par(mar=c(5.5,5.5,4,3),mgp=c(3.5,1,0),cex.lab=cexNum,cex.axis=1.2*cexNum,fig=c(0,1,0.5,1))
plot(c(ambMinBeta,ambMaxBeta),c(0,0),xlim=c(ambMinBeta-4,ambMaxBeta+8),ylim=c(0,yMax),type='l',lty='solid',lwd=2,xlab='',ylab='Count',axes=F,cex.lab=1.75*cexNum)
axis(1,c(ambMinBeta-3,seq(from=ambMinBeta,to=ambMaxBeta,by=5),ambMaxBeta+3,ambMaxBeta+7),c('Min',seq(from=ambMinBeta,to=ambMaxBeta,by=5),'Maj','U'),cex.axis=1.75*cexNum)
axis(2,seq(from=0,to=yMax+1,by=2),seq(from=0,to=yMax+1,by=2),cex.axis=1.75*cexNum)
